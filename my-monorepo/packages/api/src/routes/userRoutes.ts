...
import { getAllUsers, getUserById, createUser, updateUser, deleteUser, uploadProfilePicture } from '../controllers/userController';
...
async function userRoutes(server: FastifyInstance) {
  ...
  server.post('/user/upload-profile-picture', { preHandler: [server.authenticate] }, uploadProfilePicture);
}
